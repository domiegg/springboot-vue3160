<template>
	<div class="diy_details_box diy_div_books_and_materials">
		<div class="warp">
			<div class="container">
					...
					<div class="view praise_wrap">
						...
						{{ praiseLen }}
							...
							<div class="details_btn_wrap">
								<button class="btn btn-primary details_btn" v-if="$check_action('/books_and_materials/details','set')" @click="change_praise()" >点赞</button>
								<button class="btn btn-primary details_btn" v-if="$check_action('/books_and_materials/details','set')" @click="change_collect()" >收藏</button>
							</div>
						<!-- 富文本 -->
